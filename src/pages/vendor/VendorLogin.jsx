...
export default function VendorLogin() {
  ...
  return (
    <AuthLayout title="Vendor Login" description="Sign in to your vendor account">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2 pt-2 text-center text-sm">
          <p>
            <Link to="/vendor-signup" className="text-teal-600 hover:underline">
              Create Vendor Account
            </Link>
          </p>
          <p>
            <Link to="/user-login" className="text-zinc-500 hover:text-zinc-900">
              Sign in as User
            </Link>
          </p>
        </div>
